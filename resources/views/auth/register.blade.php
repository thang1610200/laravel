            ...
            <div class="bg-white rounded-3 shadow-sm border bg-dark border-dark" style="width: 450px;">
                <div class="p-4 pb-6">
                    ...
                    <form class="mt-4 d-grid gap-4">
                        @csrf
                        <div>
                            <label for="name" class="d-block mb-2 text-sm-start">Your name</label>
                    ...
                    <p class="text-sm-start text-black-50 mt-3">
                        Already have an account? <a href="/auth/login" style="text-decoration: none;">Login here</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            $(document).ready(function() {
                ...
                $("form :input").on('keyup', function() {
                    if (!$("#name").hasClass('border-danger') && !$("#email").hasClass('border-danger') && !$(
                        ...
                        'border-danger') && $("#name").val().trim() && $("#email").val().trim() &&
