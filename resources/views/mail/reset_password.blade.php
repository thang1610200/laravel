...
<![endif]-->
    <style type="text/css">
        ...
        @media only screen and (max-width:600px) {*[class="gmail-fix"] {
            display:none !important
        }
                        ...
                        <tr>
                            <td class="es-adaptive" align="center" style="padding:0;Margin:0">
                                <table class="es-header-body"
                                    ...
                                    <tr>
                                        <td style="Margin:0;padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px;background-color:#3D5CA3"
                                            bgcolor="#3d5ca3" align="left"><!--[if mso]><table style="width:560px" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td class="es-m-p0l es-m-txt-c" align="left"
                                                                    style="padding:0;Margin:0;font-size:0"><a
                                                                        ...
                                                                        style="mso-line-height-rule:exactly;text-decoration:none;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:14px;color:#1376C8"><img
                                                                            src="https://qqacni.stripocdn.email/content/guids/CABINET_66498ea076b5d00c6f9553055acdb37a/images/12051527590691841.png"
                                                                            alt=""
                        ...
                        <tr>
                            <td style="padding:0;Margin:0;background-color:#FAFAFA" bgcolor="#fafafa" align="center">
                                <table class="es-content-body"
                                    ...
                                    <tr>
                                        <td style="padding:0;Margin:0;padding-right:20px;padding-left:20px;padding-top:40px;background-color:transparent;background-position:left top"
                                                        ...
                                                        <table
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://qqacni.stripocdn.email/content/guids/CABINET_dd354a98a803b60e2f0411e893c82f56/images/23891556799905703.png"
                                                                        alt=""
                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                        width="175"></td>
                                                            </tr>
                                    ...
                                    <tr>
                                        <td style="padding:0;Margin:0;padding-top:20px;padding-right:10px;padding-left:10px;background-position:center center"
                                            align="left">
                                                                    ...
                                                                    <table class="es-table-not-adapt es-social"
                                                                        ...
                                                                        <tr>
                                                                            <td valign="top" align="center"
                                                                                ...
                                                                                <img src="https://qqacni.stripocdn.email/content/assets/img/social-icons/rounded-gray/facebook-rounded-gray.png"
                                                                            ...
                                                                            <td valign="top" align="center"
                                                                                style="padding:0;Margin:0;padding-right:10px">
                                                                                <img src="https://qqacni.stripocdn.email/content/assets/img/social-icons/rounded-gray/x-rounded-gray.png"
                                                                                    alt="X" title="X.com"
                                                                                    width="32"
                                                                                    style="display:block;font-size:14px;border:0;outline:none;text-decoration:none">
                                                                            </td>
                                                                            <td valign="top" align="center"
                                                                                style="padding:0;Margin:0;padding-right:10px">
                                                                                <img src="https://qqacni.stripocdn.email/content/assets/img/social-icons/rounded-gray/instagram-rounded-gray.png"
                                                                            ...
                                                                            <td valign="top" align="center"
                                                                                style="padding:0;Margin:0;padding-right:10px">
                                                                                <img src="https://qqacni.stripocdn.email/content/assets/img/social-icons/rounded-gray/youtube-rounded-gray.png"
                                                                            ...
                                                                            <td valign="top" align="center"
                                                                                style="padding:0;Margin:0;padding-right:10px">
                                                                                <img src="https://qqacni.stripocdn.email/content/assets/img/social-icons/rounded-gray/linkedin-rounded-gray.png"
                                    ...
                                    <tr>
                                        <td style="Margin:0;padding-right:20px;padding-bottom:20px;padding-left:20px;padding-top:5px;background-position:left top"
                                            align="left">
                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#666666;font-size:14px">
                                                                        Contact us: <a target="_blank"
                                                                            style="mso-line-height-rule:exactly;text-decoration:none;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:14px;color:#666666"
                                                                            href="tel:123456789">123456789</a> | <a
                                                                            target="_blank"
                                                                            href="mailto:your@mail.com"
                                                                            style="mso-line-height-rule:exactly;text-decoration:none;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:14px;color:#666666">your@mail.com</a>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                        ...
                        <tr>
                            <td style="padding:0;Margin:0;background-color:#FAFAFA" bgcolor="#fafafa" align="center">
                                <table class="es-footer-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                    ...
                                    <tr>
                                        <td style="Margin:0;padding-right:20px;padding-left:20px;padding-top:10px;padding-bottom:30px;background-color:#0B5394;background-position:left top"
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        We are here to help, learn more about us <a
                                                                            target="_blank"
                                                                            style="mso-line-height-rule:exactly;text-decoration:none;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:14px;color:#ffffff"
                                                                            href="">here</a></p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#ffffff;font-size:14px">
                                                                        or <a target="_blank"
